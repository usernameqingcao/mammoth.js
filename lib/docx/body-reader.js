    ...
    function readRunProperties(element) {
        return readRunStyle(element).map(function(style) {
            ...
            return {
                ...
                color: readColor(element.firstOrEmpty('w:color')), // 新增文字颜色解析
                bgColor: readColor(element.firstOrEmpty('w:highlight')) // 新增文本的背景色是 w:highlight 和段落的背景色有所不同
            };
        });
    }
// 新增获取颜色方法
        ...
        "w:pPr": function(element) {
            return readParagraphStyle(element).map(function(style) {
                return {
                    ...
                    bgColor: readColor(element.firstOrEmpty('w:shd')) // 新增添加背景色的解析
                };
            });
        },
